...
public class GrParser extends Parser {
	...
	public static final int
		T__0=1, STRING_LITERAL=2, INTEGER_LITERAL=3, DEC_LITERAL=4, HEX_LITERAL=5, 
		OCT_LITERAL=6, BIN_LITERAL=7, PLUS=8, MINUS=9, TIMES=10, DIV=11, MOD=12, 
		NE=13, GTE=14, GT=15, LTE=16, LT=17, EQEQ=18, CARET=19, EQ=20, ANDAND=21, 
		OROR=22, OR=23, AND=24, NOT=25, DOT=26, PLUSEQ=27, MINUSEQ=28, STAREQ=29, 
		SLASHEQ=30, PERCENTEQ=31, CARETEQ=32, ANDEQ=33, OREQ=34, LPAR=35, RPAR=36, 
		LBRC=37, RBRC=38, LSQB=39, RSQB=40, COLON=41, SEMICOLON=42, COMMA=43, 
		ARROW=44, KW_PACKAGE=45, KW_BREAK=46, KW_CONTINUE=47, KW_FN=48, KW_IF=49, 
		KW_ELSE=50, KW_WHILE=51, KW_DO=52, KW_THEN=53, KW_RETURN=54, KW_MATCH=55, 
		KW_CASE=56, KW_LET=57, KW_PUBLIC=58, KW_STRUCT=59, KW_TRUE=60, KW_FALSE=61, 
		KW_MUT=62, KW_NULL=63, IDENT=64, NUMBER=65, Alpha=66, Digits=67, WS=68, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'&&'", "'||'", "'|'", "'&'", "'!'", "'.'", "'+='", "'-='", "'*='", "'/='", 
			"'%='", "'^='", "'&='", "'|='", "'('", "')'", "'{'", "'}'", "'['", "']'", 
			"':'", "';'", "','", "'->'", "'package'", "'break'", "'continue'", "'fn'", 
			"'if'", "'else'", "'while'", "'do'", "'then'", "'return'", "'match'", 
			"'case'", "'let'", "'pub'", "'struct'", "'true'", "'false'", "'mut'", 
			"'null'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, "STRING_LITERAL", "INTEGER_LITERAL", "DEC_LITERAL", "HEX_LITERAL", 
			...
			"KW_STRUCT", "KW_TRUE", "KW_FALSE", "KW_MUT", "KW_NULL", "IDENT", "NUMBER", 
			"Alpha", "Digits", "WS", "COMMENT", "LINE_COMMENT"
		};
	}
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 864972603431845888L) != 0)) {
				{
				{
				setState(61);
				item();
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((((_la - 2)) & ~0x3f) == 0 && ((1L << (_la - 2)) & 7787480400120512643L) != 0)) {
					{
					setState(168);
					arrayElements();
					}
	...
	public final BlockExpressionContext blockExpression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 2)) & ~0x3f) == 0 && ((1L << (_la - 2)) & 8039753447509065859L) != 0)) {
				{
				setState(237);
				statements();
				}
