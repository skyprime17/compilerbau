...
public class GrParser extends Parser {
	...
	public static final int
		...
		IDENT=62, NUMBER=63, Alpha=64, Digits=65, WS=66, COMMENT=67, LINE_COMMENT=68;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"KW_STRUCT", "KW_TRUE", "KW_FALSE", "KW_MUT", "IDENT", "NUMBER", "Alpha", 
			"Digits", "WS", "COMMENT", "LINE_COMMENT"
		};
	}
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6351588763386249478L) != 0)) {
					{
					setState(168);
					arrayElements();
					}
	...
	public final BlockExpressionContext blockExpression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6856134858163355910L) != 0)) {
				{
				setState(237);
				statements();
				}
